...
destination = r'C:\Users\Iona\Pictures\University\4th Year\BE406- DISSERTATION\Data Collection\Data\FIBF5'
...
pd.concat([df1,df2, df3, df4, df5, df6],axis=1).to_csv('WITdict_dupes.csv', index = False)
