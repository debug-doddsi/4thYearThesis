...
def listbuilder(path, list):
    ...
    for entry in entries:           # for each wav file in the folder ...
        ...
        with file as source:
            ...
            # print("Sphinx thinks that you said: " + recog)   # output to console what Sphinx thinks it heard
        
            """Build the dictionary"""
            if recog not in list:   # only add this new word if it is not already featured in the list
                list.append(str(recog))
...
redpath = r'C:\Users\Iona\Pictures\University\4th Year\BE406- DISSERTATION\Python Code\Speech Recognition\Datasets (speaking colours)\Craig\3 Noise Reduction and Normalised\SPLIT\Red'
listbuilder(redpath,redlist)

bluepath = r'C:\Users\Iona\Pictures\University\4th Year\BE406- DISSERTATION\Python Code\Speech Recognition\Datasets (speaking colours)\Craig\3 Noise Reduction and Normalised\SPLIT\Blue'
listbuilder(bluepath,bluelist)

greenpath = r'C:\Users\Iona\Pictures\University\4th Year\BE406- DISSERTATION\Python Code\Speech Recognition\Datasets (speaking colours)\Craig\3 Noise Reduction and Normalised\SPLIT\Green'
listbuilder(greenpath,greenlist)

yellowpath = r'C:\Users\Iona\Pictures\University\4th Year\BE406- DISSERTATION\Python Code\Speech Recognition\Datasets (speaking colours)\Craig\3 Noise Reduction and Normalised\SPLIT\Yellow'
listbuilder(yellowpath,yellowlist)

pinkpath = r'C:\Users\Iona\Pictures\University\4th Year\BE406- DISSERTATION\Python Code\Speech Recognition\Datasets (speaking colours)\Craig\3 Noise Reduction and Normalised\SPLIT\Pink'
listbuilder(pinkpath,pinklist)

blackpath = r'C:\Users\Iona\Pictures\University\4th Year\BE406- DISSERTATION\Python Code\Speech Recognition\Datasets (speaking colours)\Craig\3 Noise Reduction and Normalised\SPLIT\Black'
...
redpath2 = r'C:\Users\Iona\Pictures\University\4th Year\BE406- DISSERTATION\Python Code\Speech Recognition\Datasets (speaking colours)\Iona\Dictionary Constuction Data\Dictionary Data 2\Noise Reduction + Normalised\cut up\red'
listbuilder(redpath2,redlist)

bluepath2 = r'C:\Users\Iona\Pictures\University\4th Year\BE406- DISSERTATION\Python Code\Speech Recognition\Datasets (speaking colours)\Iona\Dictionary Constuction Data\Dictionary Data 2\Noise Reduction + Normalised\cut up\blue'
listbuilder(bluepath2,bluelist)

greenpath2 = r'C:\Users\Iona\Pictures\University\4th Year\BE406- DISSERTATION\Python Code\Speech Recognition\Datasets (speaking colours)\Iona\Dictionary Constuction Data\Dictionary Data 2\Noise Reduction + Normalised\cut up\green'
listbuilder(greenpath2,greenlist)

yellowpath2 = r'C:\Users\Iona\Pictures\University\4th Year\BE406- DISSERTATION\Python Code\Speech Recognition\Datasets (speaking colours)\Iona\Dictionary Constuction Data\Dictionary Data 2\Noise Reduction + Normalised\cut up\yellow'
listbuilder(yellowpath2,yellowlist)

pinkpath2 = r'C:\Users\Iona\Pictures\University\4th Year\BE406- DISSERTATION\Python Code\Speech Recognition\Datasets (speaking colours)\Iona\Dictionary Constuction Data\Dictionary Data 2\Noise Reduction + Normalised\cut up\pink'
listbuilder(pinkpath2,pinklist)

blackpath2 = r'C:\Users\Iona\Pictures\University\4th Year\BE406- DISSERTATION\Python Code\Speech Recognition\Datasets (speaking colours)\Iona\Dictionary Constuction Data\Dictionary Data 2\Noise Reduction + Normalised\cut up\black'
listbuilder(blackpath2,blacklist)
