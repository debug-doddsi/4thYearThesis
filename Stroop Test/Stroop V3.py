"""Stroop Test V3"""
# Random CW pairs successful -BUT there are repeats of text and ink colours, I want to make each pair completely different to the last
# DONT KNOW HOW TO USE prevword AND prevcolour?
...
def CWpair(prevword, prevcolour):             # CWpair = Colour-Word Pair
...
set_time = 1
change = -0.25    # CHANGE THE VALUE OF DELTA-T HERE
...
def next_selected():
    ...
    while True:                             # Enter an endless loop
        word, colour = CWpair(prevword, prevcolour)
...
"""Remove excess colours from the list"""
...
del wordHISTORY[-n:]  
print('')
print('Colours of the Ink, in order of appearance:', inkHISTORY)
print('')
print('Words, in order of appearance:', wordHISTORY)
print('')
