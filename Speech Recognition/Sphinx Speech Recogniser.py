...
path = r'C:\Users\Iona\Pictures\University\4th Year\BE406- DISSERTATION\Data Collection\Data\FIBF5\Training\Noise Reduced & Normalised\Split\blue'
...
df.to_csv('StroopWords.csv', index=False)
