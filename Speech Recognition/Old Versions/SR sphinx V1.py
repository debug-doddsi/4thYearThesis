...
# r = sr.Recognizer()
# file = sr.AudioFile("single_blue.wav")
# with file as source:
...
#currently in the current working directory (CWD) that thile file is stored in
print(' ')
print('Current Working Directory (CWD): ', os.getcwd()) # tells me where my CWD is right now, where my code is saved
print(' ')
